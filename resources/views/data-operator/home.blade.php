                                        ...
                                        <div class="block block-mode-loading-oneui">
                                            ...
                                            <div class="block-content block-content-full">
                                               <div class="list-group text-center">      
                                                    <br><br>
                                                    <a href="{{ route('manage-marks-dop') }}" class="list-group-item list-group-item-action list-group-item-warning">Marks Manager</a>
                                                </div>
                                            </div>
                                            ...
                                            <div class="block-content block-content-full">
                                               <div class="list-group text-center">      
                                                    <br><br>
                                                    <a href="{{ route('manage-results-dop') }}" class="list-group-item list-group-item-action list-group-item-primary">Result Manager</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
