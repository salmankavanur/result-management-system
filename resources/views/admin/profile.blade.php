                    ...
                    <main id="main-container">
                        ...
                        <div class="content content-boxed">
                            ...
                            <div class="block">
                                ...
                                <div class="block-content">
                                    <form action="{{ route('edit-profile-ad') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                        <div class="row push">
                                            <div class="col-lg-4">
                                                ...
                                                <b>
                                                     <p class="font-size-sm text-muted">
                                                        To change your date of birth please contact the Super Admin                                                 
                                                     </p>
                                                </b>
                                            </div>
                            ...
                            <!-- END User Profile -->
                             ...
                             <!-- Change Password -->
                                <div class="block">
                                    ...
                                    <div class="block-content">
                                        <form action="{{ route('change-password-ad') }}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row push">
                                                <div class="col-lg-4">
                                                    <p class="font-size-sm text-muted">
