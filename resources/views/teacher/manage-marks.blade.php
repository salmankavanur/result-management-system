        ...
        <div class="content content-full">
            <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
                <h1 class="flex-sm-fill h3 my-2">
                    Manage Marks For {{$class}} {{$subject_name}}
                </h1>
                                                                                ...
                                                                                @foreach ($result as $result_data)
                                                                                    @if ($result_data->name == $data->name)
                                                                                        @if ($result_data->subject_name == $subject_name)
                                                                                            ...
                                                                                            <div class="form-group">
                                                                                                <label for="subject"> Total <small>Total score shows here</small><span class="text-danger">* <em> Total score is over 100</em></span></label>
